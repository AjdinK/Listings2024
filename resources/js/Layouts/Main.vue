        ...
        >
            ...
            <div class="flex gap-4 items-center">
                ...
                <div v-if="user" class="relative">
                    ...
                    >
                        <Link
                            ...
                            class="block w-full rounded-lg px-3 py-4 hover:bg-slate-700 text-left"
                            >New Listing
                        </Link>
                        <Link
                ...
                <div v-else class="space-x-6">
                    <NavLink componentName="Auth/Login" routeName="login"
                        >Login
                    </NavLink>
                    <NavLink componentName="Auth/Register" routeName="register"
                        >Register
                    </NavLink>
                </div>
