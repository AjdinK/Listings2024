...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links./home/loww/dev/Listings2024/public/storage' => 'string',
...
'filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.links./home/loww/dev/Listings2024/public/storage','logging.default','logging.deprecations.channel',
...
'solo.keybindings.default','solo.keybindings.vim','solo.commands.About','solo.commands.Vite','solo.commands.HTTP',
'solo.dump_server_host','broadcasting.default','broadcasting.connections.reverb.driver','broadcasting.connections.reverb.key','broadcasting.connections.reverb.secret',
...
'profile.password','profile.destroy','listing.create','listing.store','listing.show',
'listing.edit','listing.update','listing.destroy','admin.index','admin.role',
'user.show','admin.approve','register','login','password.request','password.email','password.reset','password.update',
'logout','verification.notice','verification.verify','verification.send','password.confirm',);
